...
/**
 * DEMO VIDEO
 * - any random url will currently resolve and provide the demo video .mp4 file
 */
for (let i = 0; i < 100; i++) {
  PLAYLIST.push(
    new PlaylistItem(
      `Training Video ${i}`,
      `https://test-rp.lukasender.at/foo-test-video-${i}`,
      true,
    ),
  );
}
...
const ICON_PLAY_BUTTON = new Icon(
  require('./assets/images/play_button.png'), // eslint-disable-line
  34,
  51,
);
const ICON_PAUSE_BUTTON = new Icon(
  require('./assets/images/pause_button.png'), // eslint-disable-line
  34,
  51,
);
const ICON_STOP_BUTTON = new Icon(
  require('./assets/images/stop_button.png'), // eslint-disable-line
  22,
  22,
);
const ICON_FORWARD_BUTTON = new Icon(
  require('./assets/images/forward_button.png'), // eslint-disable-line
  33,
  25,
);
const ICON_BACK_BUTTON = new Icon(
  require('./assets/images/back_button.png'), // eslint-disable-line
  33,
  25,
);

const ICON_LOOP_ALL_BUTTON = new Icon(
  require('./assets/images/loop_all_button.png'), // eslint-disable-line
  77,
  35,
);
const ICON_LOOP_ONE_BUTTON = new Icon(
  require('./assets/images/loop_one_button.png'), // eslint-disable-line
  77,
  35,
);

const ICON_MUTED_BUTTON = new Icon(
  require('./assets/images/muted_button.png'), // eslint-disable-line
  67,
  58,
);
const ICON_UNMUTED_BUTTON = new Icon(
  require('./assets/images/unmuted_button.png'), // eslint-disable-line
  67,
  58,
);

const ICON_TRACK_1 = new Icon(require('./assets/images/track_1.png'), 166, 5) // eslint-disable-line
const ICON_THUMB_1 = new Icon(require('./assets/images/thumb_1.png'), 18, 19) // eslint-disable-line
const ICON_THUMB_2 = new Icon(require('./assets/images/thumb_2.png'), 15, 19) // eslint-disable-line
...
export default class App extends React.Component {
  static _getMMSSFromMillis(millis) {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      // fullscreen: false, // not used according to ESLint
  ...
  async _loadNewPlaybackInstance(playing) {
    ...
    console.log(
      'DEBUG >>_loadNewPlaybackInstance -> PLAYLIST[this.index]',
      PLAYLIST[this.index],
    ) // eslint-disable-line
  ...
  _onPlaybackStatusUpdate = status => {
    console.log('DEBUG >> _onPlaybackStatusUpdate', status);
  ...
  _getTimestamp() {
    if (
      ...
      return `${App._getMMSSFromMillis(
        this.state.playbackInstancePosition,
      )} / ${App._getMMSSFromMillis(this.state.playbackInstanceDuration)}`;
    }
    return '';
  }
  ...
  _onSpeakerPressed = () => {
    this.setState(
      state => ({ throughEarpiece: !state.throughEarpiece }),
      ({ throughEarpiece }) =>
        Audio.setAudioModeAsync({
          allowsRecordingIOS: false,
          interruptionModeIOS: Audio.INTERRUPTION_MODE_IOS_DO_NOT_MIX,
